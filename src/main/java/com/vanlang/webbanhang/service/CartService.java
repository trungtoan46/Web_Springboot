...
//    public void addToCart(Long productId, int quantity, String address, String email,String note,String phoneNumber,String payment) {
...
//        cartItems.add(new CartItem(product, quantity, address, phoneNumber, email, note, payment));
//    }
